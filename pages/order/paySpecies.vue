<template>
	<view style="overflow-x: hidden;">
		...
		<view class="nav" :style="{ paddingTop: statusBarHeight + 'px' }">
			...
			<text class="nav-title">金币充值</text>
	...
	export default {
		data() {
			return {
				...
				privilegeList: [{
						pic: '/static/img/pay/coin.png',
						text: '每日金币'
					},
					{
						pic: '/static/img/pay/quan.png',
						text: '大额神券'
					},
					{
						pic: '/static/img/pay/red-bag.png',
						text: '更多返利'
					},
					{
						pic: '/static/img/pay/goods.png',
						text: '精选商品'
					},
					{
						pic: '/static/img/pay/speed.png',
						text: '极速到账'
					},
					{
						pic: '/static/img/pay/share.png',
						text: '分享领券'
					},
					{
						pic: '/static/img/pay/active.png',
						text: '专享活动'
					},
					{
						pic: '/static/img/pay/birthday.png',
						text: '生日折扣'
					},
					{
						pic: '/static/img/pay/notic.png',
						text: '上架提醒'
					},
					{
						pic: '/static/img/pay/kefu.png',
						text: '专属客服'
					}
				]
			}
