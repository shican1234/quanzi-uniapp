<template>
	<!-- 可爱卡通：猫头鹰蒙眼睛 -->
	<view class="blindfold">
		<view class="owl-cartoon" :class="hideEyes?'password':''">
...
<style lang="scss" scoped>
	.blindfold {
		...
		.owl-cartoon.password .hand {
			transform: translateX(42px) translateY(-15px) scale(0.7);
		}

		.owl-cartoon.password .hand.hand-r {
			transform: translateX(-42px) translateY(-15px) scale(0.7);
		}

		.owl-cartoon.password .arms .arm {
			transform: translateY(-40px) translateX(40px);
		}

		.owl-cartoon.password .arms .arm.arm-r {
